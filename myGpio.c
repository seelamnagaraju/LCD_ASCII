...
void initGPIO(void)
{
	...
	// Nagaraju 11/7/2020 ----------
    P1IE  |= BUTTON1; // enable interrupt for P1.1
    P1IES |= BUTTON1; // interrupt transitions from HI to LOW
    P1IE  |= BUTTON2; // enable interrupt for P1.2
    P1IES |= BUTTON2; // interrupt transitions from HI to LOW

    P1IFG = 0x00; // clear the interrupt register just in case
	//------------------------------
